...
core.register_on_joinplayer(function(player)
    ...
    huds[player:get_player_name()] = {
        ...
        health = C,
        health_txt = player:hud_add({
            type = "text",
            position = {x = 1, y = 1},
            offset = {x = -70, y = stats.health_offy},
            text = "health: "..C,
            alignment = {x = -1, y = 0},
        }),
        health_bg = player:hud_add({
            type = "image",
            position = {x = 1, y = 1},
            offset = {x = 0, y = stats.health_offy},
            text = "health.png",
            alignment = {x = -1, y = 0},
            scale = {x = stats.scalex, y = stats.scaley},
            z_index = -100,
        }),
        health_fg = player:hud_add({
            type = "image",
            position = {x = 1, y = 1},
            offset = {x = stats.scalex * C / 100, y = stats.health_offy},
            text = "fg_stat2.png",
            alignment = {x = -1, y = 0},
            scale = {x = stats.scalex, y = stats.scaley},
            z_index = -90,
...
--         core.chat_send_player(player, type(player))--string
--         --print(core.get_player_by_name(player))
-- 		--print(huds[player:get_player_name()])
--         --print(player:hud_get(huds[player:get_player_name()].hunger_txt))
--         core.chat_send_player(player, dump(core.get_player_by_name(player):hud_get(huds[player].hunger_txt)))
-- 	end,
-- })